...
// // Define a function that dynamically generates the columns based on the data
// export const TransactionColumns2 = (data: PaymentType[]): ColumnDef<PaymentType>[] => {
//   // Check if any row contains 'bank' or 'method' and dynamically adjust
//   const hasBank = data.some((item) => item.hasOwnProperty("bank"));
//   const hasMethod = data.some((item) => item.hasOwnProperty("method"));
//   console.log(hasMethod, hasBank)
...
//       },
//     },
//     // Dynamically set 'bank' or 'method' based on the data
//     hasBank
//       ? {
//           accessorKey: "bank",
//           header: "Bank",
...
//           header: "Method",
//         }
//       : null, // If neither 'bank' nor 'method', add nothing
//     {
//       accessorKey: "date",
//       header: "Date",
//     },
...
//       },
//     },
//   ].filter(Boolean) as ColumnDef<PaymentType>[]; // Filter out any `null` entries
// };
